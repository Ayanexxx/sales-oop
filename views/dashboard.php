...
<body>
            ...
            <div class="card-header bg-white border-0">
                <div class="row">
                    ...
                    <div class="col text-end">
                        <!-- data-bs-toggle="modal" data-bs-target="#add-product"　モダルに飛ばす場所を指定 -->
            ...
            <div class="card-body">
                ...
                ?>
                 <div class="container-fluid bg-dark p-5 text-danger text-center">
                    <h1 class="display-6 fw-bold pt-5 pb-3">No Records Foud</h1>
               ...
               <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="edit-product.php?product_id=<?= $product['id'] ?>" class="btn btn-warning btn-sm"
                            title="Edit Product"><i class="fa-solid fa-pen"></i></a>
    ...
    <!-- ADD PRODUCT MODAL -->
     <div class="modal fade" id="add-product" tabindax="-1" aria-labelledby="registration" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-5">
                   <h1 class="display-4 fw-bold text-info text-center">
                    <i class="fa-solid fa-box">Add Product</i>
                    </h1>
                    <form action="../actions/product-action.php" method="post" class="w-75 mx-auto pt-4 p-5">
                        <div class="row mb-3">
                            <div class="col-md">
